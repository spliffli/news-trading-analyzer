...
# 2024 Week 8 Schedule

### This was generated on 2024/01/30 and has events from **2024/02/19** to **2024/02/20**
...
<div class="card">
    ...
    <h3>Monday 19/2 @06:00 (GMT)</h3>
    <h3>Monday 19/2 @02:00 (ET)</h3>
    <h3>USDSEK</h3>
    <hr>
    <div class="triggers">
    ...
    <br>
        ...
        <div class="trigger">
        <h4>-LT1:</h4>
        <h5>c3: <span>75.6</span></h5>
        <h5>data pts: <span>28</span></h5>
        <h5>dev: <span>-0.1</span></h5>
        <h5>lots/€1k: <span>0.84</span></h5>
        <h5>lots: <span>2.52</span></h5>
        </div>
        <div class="trigger">
        <h4>-LT2:</h4>
        <h5>c3: <span>85.3</span></h5>
...
<div class="card">
    ...
    <h3>Tuesday 20/2 @12:30 (GMT)</h3>
    <h3>Tuesday 20/2 @08:30 (ET)</h3>
    <h3>USDCAD</h3>
    <hr>
    <div class="triggers">
    <h4>LTA: <span>Buy</span></h4>

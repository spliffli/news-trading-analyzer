...
for index, row in indicators.iterrows():
    ...
    if not results_file_exists:
        results = pd.DataFrame(columns=['haawks_id_str', 'haawks_title', 'inv_title', 'symbol', 'higher_dev', 'best_trigger', 'range (pips)', 'mean (pips)', 'median (pips)', 'c1', 'c2', 'lowest_ema_val'])
